...
describe('User API', function() {
  ...
  beforeEach(function(done) {
    // empty Data
    var emptyData = require("./data/emptyData").bind(null, assert, done);
    emptyData(Category, Product, User);

  });

  beforeEach(function(done) {
    // create test Data
    var createData = require("./data/createData").bind(null, assert, done, PRODUCT_ID);
    createData(Category, Product, User);
